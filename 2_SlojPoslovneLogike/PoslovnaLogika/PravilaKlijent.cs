...
{
    // Klijent koji poziva REST Web Servis za citanje poslovnih pravila iz eksternog
    // XML parametra (Pravila.xml). Ukljucuje i spisak obrazovnih profila koji
    // zahtijevaju dodatne specijalisticke preglede za validnost lekarskog uvjerenja.
    public class PravilaKlijent
    {
        ...
        // Poslovno pravilo: profili koji zahtijevaju dodatne specijalisticke preglede
