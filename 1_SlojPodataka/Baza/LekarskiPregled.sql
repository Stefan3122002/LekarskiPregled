...
-- (WebServis/XML/Pravila.xml) koji propisuje koji profili zahtevaju
...
CREATE TABLE [dbo].[ObrazovniProfil] (
    ...
    [NivoZahtevnosti]  [int] NOT NULL DEFAULT(1),
...
GO
ALTER TABLE [dbo].[LekarskiPregled]
    ADD CONSTRAINT [FK_LekarskiPregled_Korisnik] FOREIGN KEY([KorisnikID]) REFERENCES [dbo].[Korisnik]([KorisnikID])
GO
...
ALTER TABLE [dbo].[ObrazovniProfil]
    ADD CONSTRAINT [CHK_NivoZahtevnosti] CHECK ([NivoZahtevnosti] >= 1 AND [NivoZahtevnosti] <= 5)
GO

-- =============================================
-- Podaci: ObrazovniProfil
-- Sifre 142, 233, 310, 405 se nalaze u WebServis/XML/Pravila.xml kao profili
-- koji zahtevaju dodatne specijalisticke preglede. Sifre 018 i 025 ne
-- zahtevaju dodatne preglede - obicno lekarsko uverenje je dovoljno.
-- =============================================
SET IDENTITY_INSERT [dbo].[ObrazovniProfil] ON
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (1, N'025', N'Gimnazija - opsti smer',        N'Opsteobrazovni smer bez dodatnih zdravstvenih uslova', 1)
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (2, N'018', N'Ekonomski tehnicar',              N'Ekonomsko-pravni smer', 1)
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (3, N'142', N'Elektrotehnicar racunara',        N'Zahteva proveru vida i sluha', 3)
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (4, N'233', N'Kozmeticki tehnicar',             N'Zahteva dermatoloski pregled', 2)
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (5, N'310', N'Vozac motornih vozila',           N'Zahteva proveru vida, sluha i neuropsihijatrijski pregled', 4)
INSERT [dbo].[ObrazovniProfil] ([ProfilID],[Sifra],[Naziv],[Opis],[NivoZahtevnosti])
    VALUES (6, N'405', N'Sportski smer - fudbal',         N'Zahteva kardioloski i ortopedski pregled', 5)
...
INSERT [dbo].[LekarskiPregled] ([PregledID],[KandidatID],[DatumPregleda],[ZdravstvenaUstanova],[AdresaUstanove],[TrajanjePregledaMinuta],[BrojLekaraUKomisiji],[Zavrsen],[Napomena])
    VALUES (2, 2, '2026-05-12 10:30:00', N'Dom zdravlja Novo Sarajevo', N'Zmaja od Bosne 44, Sarajevo', 30, 2, 1, N'Kandidat konkurise za tehnicki smer')
INSERT [dbo].[LekarskiPregled] ([PregledID],[KandidatID],[DatumPregleda],[ZdravstvenaUstanova],[AdresaUstanove],[TrajanjePregledaMinuta],[BrojLekaraUKomisiji],[Zavrsen],[Napomena])
...
-- (oftalmolog + ORL) => uverenje je validno.
-- Kandidat 3 (Sportski smer - sifra 405) ima samo kardiologa, nedostaje
-- ortoped => uverenje NIJE validno dok se ne prilozi nedostajuci nalaz.
-- =============================================
...
BEGIN
    SET NOCOUNT ON;
    SELECT ProfilID, Sifra, Naziv, Opis, NivoZahtevnosti FROM ObrazovniProfil ORDER BY Naziv;
END
GO
...
BEGIN
    ...
    SELECT p.PregledID          AS [ID],
           ...
           p.BrojLekaraUKomisiji AS [Lekara u komisiji],
